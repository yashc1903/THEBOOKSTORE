...
function ForgotPassword() {
    ...
    const handleSubmit = async(e) =>{
        e.preventDefault()
        try {
            const res = await axios.post(`http://localhost:8080/forgot-password`,{email,newPassword,answer})
    ...
    <div className=' w-full ' >
        ...
        <div className=' pt-20 pl-32 w-full'>
            <form className=" w-full max-w-[540px]" onSubmit={handleSubmit}  >
                ...
                <div className='w-full' >
                    <button className=' w-full bg-purple-800 h-20  rounded-lg text-white text-3xl mt-10'type='submit' > Reset Password </button>
                </div>
