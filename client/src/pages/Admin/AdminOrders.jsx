        ...
        <div className="w-3/4  min-h-full p-4 overflow-y-auto">
          ...
          {filteredOrders.length > 0 ? (
                      ...
                      <div key={p._id} className="flex flex-col md:flex-row bg-opacity-45 items-center justify-between p-4 mb-4 rounded-md shadow-lg bg-white">
                        ...
                        <div className="flex flex-col text-left w-full md:w-2/3">
                          <ul>
                            ...
                            <li className="text-indigo-900 text-xl mb-4"><span className="text-black">By:</span> {p.author}</li>
            ...
            <div className="text-center mt-8">
              <img src={emptyBoxImage} alt="Empty Box" className="mx-auto mb-4" style={{ width: '50vw' }} />
