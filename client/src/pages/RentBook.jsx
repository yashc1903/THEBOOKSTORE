    ...
    <>
      <Layout>
        <div className="w-full py-4">
          <h1 className="text-center text-4xl mx-auto bg-white  font-semibold text-black  rounded-full bg-opacity-80 w-1/3 h-10   mb-4">
            Products Available for Rent
          </h1>
          <div className="flex flex-wrap justify-around gap-1">
            {products?.map((product) => (
              <div key={product._id} className="hover:z-50 w-1/5 my-3 ">
                <div className="card bg-gradient-to-tr from-rose-100 to-teal-100  border-2 border-gray-800 shadow-lg rounded-lg flex flex-col justify-between p-4 gap-4 h-full transform transition-transform duration-300 hover:scale-110 hover:z-10 ">
                  ...
                  <div className="card-footer flex justify-between items-center mt-auto">
                    ...
                    <button
                      className="w-34 h-10 rounded-md p-6 py-2  border-2 border-black font-sm text-gray-800 bg-transparent cursor-pointer transition-all duration-300 relative  shadow-inner shadow-gray-400 hover:shadow-none focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
