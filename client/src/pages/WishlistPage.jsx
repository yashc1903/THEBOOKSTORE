  ...
  return (
    ...
    <Layout>
        <div className="min-w-full text-center p-4">
            <h1 className="text-center text-3xl text-black mb-4 bg-white font-semibold bg-opacity-90 px-4 py-2 mx-auto rounded-full inline-block">
                {wishlist?.length === 0 
                    ? 'Your wishlist is empty' 
                : wishlist.length === 1 
                    ? 'You’ve 1 book in your wishlist' 
                    : `You’ve ${wishlist.length} books in your wishlist`}
            </h1>
        ...
        <div className="min-w-full flex min-h-screen p-4 ">
            <div className="w-full text-center p-4 ">
                <div>
                    {wishlist?.map(item => (
                        <div className="flex flex-col md:flex-row items-center justify-between p-4 mb-4 rounded-md shadow-2xl w-full bg-white bg-opacity-80" key={item._id}>
