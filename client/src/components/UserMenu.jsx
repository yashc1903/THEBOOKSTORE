...
function UserMenu({style}) {
  return (
    <>
      ...
      <h2 className="text-2xl font-bold mb-4 mt-4 text-black text-center">USER DASHBOARD</h2>
      <div className="flex flex-col items-center text-center ">
        ...
        <NavLink to='/dashboard/user/sell-product' className="text-xl rounded-full  bg-white bg-opacity-60 text-black font-semibold border p-4 mb-4 w-56">Sell Book</NavLink>
